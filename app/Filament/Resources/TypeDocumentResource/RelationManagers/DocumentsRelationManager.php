...
namespace App\Filament\Resources\TypeDocumentResource\RelationManagers;
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('typeDocument.Title')->limit(
                    50
                ),
                Tables\Columns\TextColumn::make('Attach')->limit(50),
                Tables\Columns\TextColumn::make('Valide')->limit(50),
            ...
            ->filters([
                ...
                MultiSelectFilter::make('type_document_id')->relationship(
                    'typeDocument',
                    'Title'
                ),
            ])
